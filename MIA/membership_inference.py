    ...
    def _fit(self, X, y, num_itr=100):
        ...
        for model_idx in range(self.num_models):
            ...
            shadow_indices = self._prng.choice(
                indices, 6 * self.shadow_dataset_size, replace=False
            )

            train_indices = shadow_indices[: self.shadow_dataset_size*5]
            test_indices = shadow_indices[self.shadow_dataset_size*5 :]
